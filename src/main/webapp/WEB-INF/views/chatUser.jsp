...
<div class="layui-row">
    <div style="font-size: 30px;font-family: 宋体;margin-left: 40%;">客服在线咨询</div>
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        websocket = new WebSocket(
            "ws://localhost:8081/AgriculturalSales/websocketTest/${sessionScope.user.phone}");
    ...
    websocket.onopen = function(event) {
        setMessageInnerHTML("<hr>\n" +
            "        <div class=\"div4\"> <span style=\"font-size: 10px;\">连接成功！</span></div>\n" +
            "        <hr>");
        websocket.send("你好！我是${sessionScope.user.phone}");
    }
    console.log("-----")
    //接收到消息的回调方法
